...
RUN apt-get update -q && apt-get install -y -q ninja-build cmake pkg-config libpng-dev libmypaint-dev libraw-dev libzstd-dev libsqlite3-dev libgl1-mesa-dev g++ python3 python3-pip curl \\
