...
struct ColorOverlay { EffectBlend mode = EffectBlend::Normal; StyleColor color{255, 0, 0}; float opacity = 1; };
struct GradientOverlay { EffectBlend mode = EffectBlend::Normal; float opacity = 1; StyleGradient gradient; };
