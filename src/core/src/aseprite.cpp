...
/// Aseprite's blend mode numbers; the ones NekoPhoto lacks are empty (none, since Photoshop's full set came in).
std::optional<BlendMode> blendFromAseprite(uint16_t mode) {
    ...
    case 16: return BlendMode::LinearDodge;   // Aseprite's Addition
    case 17: return BlendMode::Subtract;
    case 18: return BlendMode::Divide;
