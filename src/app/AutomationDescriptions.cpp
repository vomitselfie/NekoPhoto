...
const MethodDoc methodDocs[] = {
    ...
    {"document.open", "Open a project (.comp), Photoshop (.psd/.psb), Clip Studio (.clip), Aseprite (.ase/.aseprite, first frame), icon (.ico/.cur, a layer per size), animated GIF (a layer per frame) or image file (.tga included). Layered files open in a new tab and the reply lists their layers and notes; with a document already open, an image is imported as a layer.",
    ...
    {"document.export", "Export as a layered Photoshop .psd (the reply lists what Photoshop cannot carry), or the composite as .png, .jpg, .webp, .tif, .tga or .ico (16, 32, 48 and 256 px; the extension decides).",
