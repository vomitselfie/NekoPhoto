...
const MethodDoc methodDocs[] = {
    ...
    {"document.open", "Open a project (.comp), Photoshop (.psd/.psb), Clip Studio (.clip), Affinity (.afphoto/.afdesign/.afpub/.af), image or camera RAW file (when app.info reports raw). With a document already open, an image is imported as a layer.",
